...
**流派**: 道家 (Daoism)
**英文名**: Tao Te Ching
**来源**: [中国哲学书电子化计划](https://ctext.org/dao-de-jing/zh)
...
```bash
# 获取JSON格式数据
curl "https://ctext.org/dao-de-jing/zh?format=json" \
...
1. 访问 [https://ctext.org/dao-de-jing/zh](https://ctext.org/dao-de-jing/zh)
2. 选择文本版本（如" Plaincat"）
3. 复制原文粘贴到此文件
...
**待下载链接**: https://ctext.org/dao-de-jing/zh
**创建时间**: 2026-04-16
**状态**: 待手动下载原文
