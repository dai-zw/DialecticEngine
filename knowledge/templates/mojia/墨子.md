...
**流派**: 墨家 (Mohism)
**英文名**: Mozi
**来源**: [中国哲学书电子化计划](https://ctext.org/mozi/zh)
...
```bash
# 获取JSON格式数据
curl "https://ctext.org/mozi/zh?format=json" \
...
1. 访问 [https://ctext.org/mozi/zh](https://ctext.org/mozi/zh)
2. 选择文本版本（如" Plaincat"）
3. 复制原文粘贴到此文件
...
3. **元数据字段**:
   ...
   - `chapter`: "第一章"等
   - `dynasty`: "先秦"等
   - `source_url`: "https://ctext.org/mozi/zh"
