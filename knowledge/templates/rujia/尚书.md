...
format: "Markdown"
description: "诸子百家核心经典 - 尚书"
---

# 尚书

**流派**: 儒家 (Confucianism)
**英文名**: Book of Documents
**来源**: [中国哲学书电子化计划](https://ctext.org/shang-shu/zh)
...
```bash
# 获取JSON格式数据
curl "https://ctext.org/shang-shu/zh?format=json" \
...
1. 访问 [https://ctext.org/shang-shu/zh](https://ctext.org/shang-shu/zh)
2. 选择文本版本（如" Plaincat"）
3. 复制原文粘贴到此文件
...
3. **元数据字段**:
   ...
   - `chapter`: "第一章"等
   - `dynasty`: "先秦"等
   - `source_url`: "https://ctext.org/shang-shu/zh"
...
**待下载链接**: https://ctext.org/shang-shu/zh
**创建时间**: 2026-04-16
**状态**: 待手动下载原文
