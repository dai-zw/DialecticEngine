...
chinese_title: "礼记"
english_title: "Book of Rites"
school: "Confucianism"
source: "中国哲学书电子化计划"
url: "https://ctext.org/liji/zh"
downloaded: "2026-04-16"
format: "Markdown"
description: "诸子百家核心经典 - 礼记"
---
...
**流派**: 儒家 (Confucianism)
**英文名**: Book of Rites
**来源**: [中国哲学书电子化计划](https://ctext.org/liji/zh)
...
```bash
# 获取JSON格式数据
curl "https://ctext.org/liji/zh?format=json" \
...
1. 访问 [https://ctext.org/liji/zh](https://ctext.org/liji/zh)
2. 选择文本版本（如" Plaincat"）
3. 复制原文粘贴到此文件
...
3. **元数据字段**:
   ...
   - `chapter`: "第一章"等
   - `dynasty`: "先秦"等
   - `source_url`: "https://ctext.org/liji/zh"
